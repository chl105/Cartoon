...
public class TabLayoutBuilder extends XTabLayout {
     ...
     * @param index Index for TabLayout
     */
    ...
    public static final class ItemStatus {
        ...
        public ItemStatus(CharSequence title, @IdRes int normalResId, @IdRes int selectedResId,
                          int normalTitleColor, int selectedTitleColor) {
            this.title = title;
        ...
        public ItemStatus(CharSequence title, @IdRes int drawableSelectorId, int normalTitleColor,
    ...
    public Tab newTab() {
        ...
        tab.mView.setGravity(Gravity.BOTTOM);
        return tab;
    }
