...
public class XTabLayout extends HorizontalScrollView {
    ...
    private XTabLayoutOnPageChangeListener mPageChangeListener;
    ...
    public XTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabTextSize = a.getDimensionPixelSize(R.styleable.XTabLayout_tabTextSize, dpToPx(17));
     ...
     * The one-stop shop for setting up this {@link XTabLayout} with a {@link ViewPager}.
     *
     * <p>This method will link the given ViewPager and this XTabLayout together so that
    ...
    private void setupWithViewPager(@Nullable final ViewPager viewPager, boolean autoRefresh,
        ...
        if (viewPager != null) {
            ...
            if (mPageChangeListener == null) {
                mPageChangeListener = new XTabLayoutOnPageChangeListener(this);
            }
     ...
     *             together. When that method is used, the XTabLayout will be automatically updated
    ...
    private void addViewInternal(final View child) {
        if (child instanceof XTabItem) {
            ...
            throw new IllegalArgumentException("Only XTabItem instances can be added to XTabLayout");
        }
    }
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public void onMeasure(final int origWidthMeasureSpec, final int origHeightMeasureSpec) {
            ...
            if (mTextView != null) {
                ...
                System.out.println("AAA: The TabTextSize is :"+textSize);
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            super.draw(canvas);
            float partWidth = (mIndicatorRight - mIndicatorLeft)/4;
            System.out.println("Test!!!"+partWidth);
            RectF rectF = new RectF(mIndicatorLeft + partWidth, getHeight() - mSelectedIndicatorHeight,
                    mIndicatorRight - partWidth, getHeight());
            // Thick colored underline below the current selection
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                canvas.drawRoundRect(rectF, dpToPx(2), dpToPx(2), mSelectedIndicatorPaint);
...
//                        mIndicatorRight, getHeight(), mSelectedIndicatorPaint);
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        ...
        // We return the default layout params so that we don't blow up if we're given a XTabItem
    ...
    public static class XTabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final XTabLayout tabLayout = mXTabLayoutRef.get();
            if (tabLayout != null) {
